...
%           end
            ...
            fprintf(fid,[' and plane(0,0,0;0,0,-1)\n' ...
                '      and  plane(0,0,%.10f;0,0,1)'],tank_height);
            fprintf(fid,';\n');
        end
    end
   ...
   fprintf(fid,'curve3d extrsncurve=(2; 0,0,0; 0,0,%.10f; 1; 2,1,2);\n', ...
       tank_height+1);
   ...
   for i = 1:length(tank_shape.additional_shapes)
       ...
       fprintf(fid,['solid %s= plane(0,0,%.10f;0,0,-1)\n' ...
           '      and  plane(0,0,%.10f;0,0,1)\n' ...
...
% direction is in the xy plane
    ...
    fprintf(fid,['  outer_bound and not inner_bound and '...
        'cylinder(%.10f,%.10f,%.10f;%.10f,%.10f,%.10f;%.10f) '...
        'and plane(%.10f,%.10f,%.10f;%.10f,%.10f,%.10f) '...
        'and not bound;\n'], ...
...
% direction is in the xy plane
   ...
   fprintf(fid,' plane(%.10f,%.10f,%.10f;%.10f,%.10f,%.10f  )\n', ...
