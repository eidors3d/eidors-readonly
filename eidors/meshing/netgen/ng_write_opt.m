...
switch str
    case 'very_coarse'
        % fineness 1
        v = [6, 1, 0.3, 0.7, 0.25, 0.8, 0.2, 0.5, 0.25, 1];
    case 'coarse'
        % fineness 2
        v = [6, 1.5, 0.5, 0.5, 1, 0.35, 1, 0.5, 1.5];
    case 'moderate'
        % fineness 3
        v = [6, 2, 1, 0.3, 1, 1.5, 0.5, 2, 1, 2];
    case 'fine'
        % fineness 4
        v = [6, 3, 2, 0.2, 1.5, 2, 1.5, 3.5, 1.5, 3];
    case 'very_fine'
        % fineness 5
        v = [6, 5, 3, 0.1, 3, 5, 3, 5, 3, 5];
end
