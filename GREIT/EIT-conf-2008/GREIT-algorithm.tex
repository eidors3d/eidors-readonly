% $Id: GREIT-algorithm.tex,v 1.13 2008-04-16 11:00:22 aadler Exp $
...
\date{\bf DRAFT ($Date: 2008-04-16 11:00:22 $): Please note that the
...
{\small
\noindent $^1$Systems and Computer Engineering,
               Carleton University, Ottawa, Canada \\
\noindent $^3$Health and Social Sciences,
               Middlesex University, London, UK \\
\noindent $^4$Thayer School of Engineering,
               Dartmouth College, Hanover, NH, USA \\
\noindent $^{12}$School of Mathematics,
               University of Manchester, UK \\
\noindent $^{13}$Intensive and Critical Care Medicine,
...
goal to development of this algorithm. Participants have
agreed not to seek patent protection on approach,
...
In the remainder of this paper, we clarify two aspects GREIT:
...
$\xB = f(\sG^{(2)}_r) - f(\sG^{(1)}_r)$ is the (parametrized) 
...
EIT data from Groups in Kiel and G\"ottingen (Hahn \etal, 
