function img=inv_solve_TV_lagged_diffusivity( inv_model, data1, data2)
% INV_SOLVE_TV_LAGGED_DIFFUSIVITY Lagged Diffusivity Inverse Solver
...
try    beta = inv_model.inv_solve_TV_lagged_diffusivity.beta; 
catch  beta = 1e-3;
end
...
img.name = 'inv_solve_TV_lagged_diffusivity';
