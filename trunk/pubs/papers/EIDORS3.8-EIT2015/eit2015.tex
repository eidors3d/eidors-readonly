...
%\fbox{ \parbox[r][2cm][c]{.35\columnwidth}{ mesh-eidors3p8.pdf }}
...
\item Improved interfaces to NetGen and visualization.
      Support for compound and point electrodes in NetGen.
...
\includegraphics[width=.96\columnwidth]{loc-fixed.pdf}
%\fbox{ \parbox[r][3cm][c]{.96\columnwidth}{ loc-fixed.pdf }}
