...
such as the planar placement of electrodes and the consequent
...
online 
\verb$www.eidors.org/data_contrib/db_backproj_matrix$
...
either side of the sternum, and rotate the remaining 
...
We recommend that a minimum FEM model size of 25,0000
elements.
...
forward models. While 2D models could be
...
ethical constraints, CT data of healthy infants are not 
...
\begin{figure}[bhtp]
\begin{center}
\includegraphics[width=0.15\textwidth]{figures/example_images_111.png}
\includegraphics[width=0.15\textwidth]{figures/example_images_211.png}
\includegraphics[width=0.15\textwidth]{figures/example_images_411.png}
\\
\includegraphics[width=0.15\textwidth]{figures/example_images_112.png}
\includegraphics[width=0.15\textwidth]{figures/example_images_212.png}
\includegraphics[width=0.15\textwidth]{figures/example_images_412.png}
\caption{
...
Biological Eng} ed H Hutten and P Kr¨ osl (Graz: Verlag der TU Graz) p
110--111
