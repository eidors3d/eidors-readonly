...
artefacts can be incorrectly interpreted (ie. movement of
...
the reconstructed medium. The square root is used 
...
a forward model, physical or numerical, is suitable
for this procedure.
