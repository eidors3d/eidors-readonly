...
The medium diameter
and height is $30$~cm with a maximum element size of $1$~cm.
...
results of this paper. The turquoise circles indicate the
positions of conductivity targets, $\xB_t$.
}
\end{center}
\end{figure}
...
\begin{center}
\includegraphics[width=0.8\textwidth,
                 bb=0.0in 1.0in 10in 6.0in,page=1]
...
a small turquoise circle. The ``Radius'' indicate
