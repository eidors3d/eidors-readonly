...
% $Id: adler-lionheart-2005-EIDORS.tex,v 1.41 2005-12-05 22:11:52 aadler Exp $
...
% Response to reviewers and new issues to deal with in 
% EIDORS V3.1
%
% - Note EIDORS 3.1 release
% - comment on TV, Kalman filtering, etc
% - Unit matching - hp^2 
% - RtR_prior vs R_prior
% - modify figures
...
functions are shown in Figs. \ref{fig:fig_3d_2rings} and \ref{fig:fig_3d_zigzag}.
...
the caching the computed result. In this case, if a
...
how to change in electrode configuration and stimulation 
...
than for Fig. \ref{fig:fig_3d_2rings}; this is to be expected this configuration
