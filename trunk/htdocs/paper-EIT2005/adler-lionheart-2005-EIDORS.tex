...
% $Id: adler-lionheart-2005-EIDORS.tex,v 1.23 2005-11-03 23:28:47 aadler Exp $
...
\begin{verbatim}
{\tt J= calc\_jacobian( fem, img\_bkgnd )}
\end{verbatim}
...
\begin{verbatim}
    ...
    conductivity=    ones( n_elems, 1); 

    img_sim= eidors_obj('image', 'demo');
    img_sim.elem_data = conductivity;
