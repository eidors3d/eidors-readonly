...
% $Id: adler-lionheart-2005-EIDORS.tex,v 1.13 2005-11-02 04:49:03 aadler Exp $
...
\begin{figure}[th]
\begin{flushright}
\includegraphics[width= 0.25 \textwidth]{./sad.eps}
\includegraphics[width= 0.25 \textwidth]{./happy.eps}
\caption{\small The 
{\em happy transform}
 }
...
\begin{figure}[th]
\begin{flushright}
\includegraphics[width= 0.80 \textwidth]{./fig_noise.eps}
\caption{\small 
