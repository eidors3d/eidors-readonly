...
% $Id: adler-lionheart-2005-EIDORS.tex,v 1.26 2005-11-05 13:26:03 aadler Exp $
...
\CN 08 \CC mdl.fwd_model.electrode=  ... @\\
\CN    \CC     mdl.fwd_model.electrode( select(:) ); @\\
\CN    \CC n_elecs= 16; @\\
\CN    \CC n_rings= 1; @\\
\CN 12 \CC mdl.fwd_model.stimulation = mk_stim_patterns( ... @\\
\CN    \CC              n_elecs, n_rings, '{ad}', '{ad}'); @\\
\CN    \CC @\\
