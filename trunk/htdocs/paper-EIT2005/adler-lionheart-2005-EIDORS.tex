...
% $Id: adler-lionheart-2005-EIDORS.tex,v 1.19 2005-11-03 04:47:52 aadler Exp $
...
{\tt z\_contact} (scalar) and {\tt nodes} (vector)
 which represent the
(possibly complex) contact impedance (in $\Omega$)
...
measures or simulated data. The structure of the
{\tt data} objects is shown in \ref{fig:data}. The
required fields are {\tt time} in seconds 
...
stimulation electrodes, given $M = E\times(E-3)$,
where $E$ is the number of electrodes. 
meas\_select
...
of current inputs to each vertex.
