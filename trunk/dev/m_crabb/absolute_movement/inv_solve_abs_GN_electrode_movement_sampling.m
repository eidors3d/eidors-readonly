...
[maxiter, tol,alpha,bls] = get_parameters(inv_model);

%Grab the forward model
fwd_model=inv_model.fwd_model;

%Calculate useful electrode information i.e. tangents, normal etc.
elec_comp=calc_electrode_components(fwd_model);

%Grap the positions and use this as a prior
...
for i=1:maxiter
    ...
    J = jacobian_electrode_movement_sampling(img_bkgnd);
