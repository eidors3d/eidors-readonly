    ...
    if (strcmp(eletype,'tri3') || strcmp(eletype,'tet4'))
        ...
        for ii=1:nelems
            ...
            if(nodedim==2) %2D problemm
                ...
                [rownode1,~]=find(elemstrucold==elemiinodes(1));
                [rownode2,~]=find(elemstrucold==elemiinodes(2));
                [rownode3,~]=find(elemstrucold==elemiinodes(3));
            ...
            elseif(nodedim==3) %3D problem
                ...
                [rownode2,~]=find(elemstrucold==elemiinodes(2));
                [rownode3,~]=find(elemstrucold==elemiinodes(3)); 
                [rownode4,~]=find(elemstrucold==elemiinodes(4));
