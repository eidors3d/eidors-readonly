...
% and large matrix operations can be performed efficiently in parallel.
%
% stim may be a structure as fwd_model.stimulation(:) 
% or a matrix Kx4 of [A B M N] with A and B the injecting electrodes and
% M and N the measuring electrodes, K being the total number of protocols
% used for stimulation and measurement patterns
% current= drive current levels,     DEFAULT = 1 Amp
