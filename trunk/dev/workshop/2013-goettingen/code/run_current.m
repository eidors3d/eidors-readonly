...
idx = rem( (0:15)*5, 16) + 1;
fmdl2.electrode = fmdl2.electrode(idx);
fmdl3.electrode = fmdl3.electrode(idx);
...
imgs = mk_image(img2,sens)
imgs.calc_colours.cb_shrink_move=[0.2,0.8,0];
show_slices(imgs);
