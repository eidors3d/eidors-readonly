...
function [c2f, m]= do_mk_grid_c2f(fmdl,rmdl,opt)
    ...
    if 1
       opt.Zsz = 1;
       opt.nVox = opt0.Xsz*opt.Ysz;
       opt.zvec = opt0.zvec(1:2);
       opt.xplane = opt0.xplane(1,:);
       opt.yplane = opt0.yplane(1,:);
       rmdl.elems = rmdl0.elems((1:6*opt.nVox),:);
       ...
       fmdl.normals = fmdl.normals(fface_idx,:);
       fmdl.faces = fmdl.faces(fface_idx,:);
