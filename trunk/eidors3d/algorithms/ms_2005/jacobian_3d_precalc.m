function [J] = jacobian_3d(I,elec,vtx,simp,gnd_ind,Vref,zc,v_f,df,tol,sym,D,Ela);
% [J] = jacobian_3d(I,elec,vtx,simp,gnd_ind,Vref,zc,v_f,df,tol,sym,D,Ela);
%
%This function calculates the Jacobian (sensitivity) matrix of the system at
%mat_ref. 
%
% Modified from old version takes Vref, D, Ela, and not mat_ref
...
%Vref  = The reference conductivity vector
...
% $Id: jacobian_3d_precalc.m,v 1.3 2007-08-29 09:00:56 aadler Exp $
