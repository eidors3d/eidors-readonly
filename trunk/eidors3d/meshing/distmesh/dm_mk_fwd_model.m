function [fwd_mdl]= dm_mk_fwd_model( fd, h0, bbox, elec_nodes, ...
                     refine_nodes, stim_pattern, z_contact, name)
...
% $Id: dm_mk_fwd_model.m,v 1.9 2008-03-27 14:26:53 aadler Exp $

if nargin <8
   name = 'MDL from dm_mk_fwd_model';
end
fwd_mdl= create_refined_model(name, fd, h0, bbox, elec_nodes, ...
                        refine_nodes, stim_pattern, z_contact); 
