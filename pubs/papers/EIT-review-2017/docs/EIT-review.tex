...
EIT systems typically apply sinusiodal currents to the
...
of electrodes is measured (\fref{fig:blockdiaPairdrive}).
...
\begin{figure} \centering
   \subcaptionbox{\centering Adjacent [1,2],[3,4]}[0.25\columnwidth]{\includegraphics[width=0.25\columnwidth]{skip11.png}}\hfil%
   \subcaptionbox{\centering Adjacent [1,2],[4,5]}[0.25\columnwidth]{\includegraphics[width=0.25\columnwidth]{skip12.png}}\hfil%
   \subcaptionbox{\centering Adjacent [2,3],[4,5]}[0.25\columnwidth]{\includegraphics[width=0.25\columnwidth]{skip13.png}}\\
   \subcaptionbox{\centering Skip\,2 [1,4],[2,5]}[0.25\columnwidth]{\includegraphics[width=0.25\columnwidth]{skip21.png}}\hfil
   \subcaptionbox{\centering Skip\,2 [1,4],[3,6]}[0.25\columnwidth]{\includegraphics[width=0.25\columnwidth]{skip22.png}}\hfil
   \subcaptionbox{\centering Skip\,2 [2,5],[3,6]}[0.25\columnwidth]{\includegraphics[width=0.25\columnwidth]{skip23.png}}\\
\caption{%
...
\begin{figure}
\centering
   \subcaptionbox{\centering Drive electrode}[0.45\columnwidth]{\includegraphics[width=0.45\columnwidth]{stream1.pdf}}\hfil
   \subcaptionbox{\centering Measurement electrode}[0.45\columnwidth]{\includegraphics[width=0.45\columnwidth]{stream2.pdf}}\\
...
\begin{figure} \centering
   \subcaptionbox{\centering Dual FEM mesh}[0.45\columnwidth]{\includegraphics[width=0.45\columnwidth]{fem.pdf}}\hfil
...
\begin{figure} \centering
   \subcaptionbox{\centering Single measurement}[0.30\columnwidth]{\includegraphics[width=0.30\columnwidth]{sens1.png}}\hfil%
   \subcaptionbox{\centering Adjacent}[0.30\columnwidth]{\includegraphics[width=0.30\columnwidth]{sens2.png}}\hfil%
   \subcaptionbox{\centering Skip-4}[0.30\columnwidth]{\includegraphics[width=0.30\columnwidth]{sens3.png}}\\
   \centering \includegraphics[width=0.75\columnwidth]{sens-cb.png}\\
\caption{%
...
\begin{figure} \centering
   \includegraphics[width=0.47\columnwidth]{fig07-offplane-sens-1plane_F.pdf}
   \includegraphics[width=0.47\columnwidth]{fig07-offplane-sens-2pl_sqF.pdf}
\caption{%
...
\begin{figure} \centering
   \includegraphics[width=0.95\columnwidth]{fig08_conductivity_contrast.pdf}
\caption{%
...
\begin{equation}
\| \yB - F(\xH) \|^2_\WB + \lambda^2\| \xH - \xB^* \|^2_\QB,
...
estimate, $\xH$, and an {\em a priori} estimate of its value, $\xB^*$.
For aEIT, accurate estimation of this value is important for convergence.
For difference EIT, $\xB^*=0$, since increases and decreases are
equally likely.
...
an iterative update, $\xH^{(k+1)} = \xH^{(k)} + \delta\xH$ 
starting at $\xH^{(0)} = \xB^*$, using the update
\begin{equation}
\delta\xH= 
...
% Maybe chose an image that makes Tikhonov look worse
   \subcaptionbox{\centering Model}[0.50\columnwidth]{\includegraphics[width=0.50\columnwidth]{hp1.png}}\\
   \subcaptionbox{\centering   Tikhonov}[0.90\columnwidth]{%
      \includegraphics[width=0.30\columnwidth]{hp41.png}~~%
      \includegraphics[width=0.30\columnwidth]{hp31.png}~~%
      \includegraphics[width=0.30\columnwidth]{hp21.png}}\hfil%
   \subcaptionbox{\centering   Laplace}[0.90\columnwidth]{%
      \includegraphics[width=0.30\columnwidth]{hp42.png}~~%
      \includegraphics[width=0.30\columnwidth]{hp32.png}~~%
      \includegraphics[width=0.30\columnwidth]{hp22.png}}\hfil%
   \subcaptionbox{\centering   Noser}[0.90\columnwidth]{%
      \includegraphics[width=0.30\columnwidth]{hp43.png}~~%
      \includegraphics[width=0.30\columnwidth]{hp33.png}~~%
      \includegraphics[width=0.30\columnwidth]{hp23.png}}\hfil%
   \subcaptionbox{\centering   Total Variation}[0.90\columnwidth]{%
      \includegraphics[width=0.30\columnwidth]{hp45.png}~~%
      \includegraphics[width=0.30\columnwidth]{hp35.png}~~%
      \includegraphics[width=0.30\columnwidth]{hp25.png}}\hfil%
   \centering \includegraphics[width=0.70\columnwidth]{hp-cb.png}\\
\caption{%
...
\begin{figure} \centering
   \includegraphics[width=0.95\columnwidth]{fig10-hypoventilation-fraction.pdf}
\caption{%
