...
%
% $Id: simulate_3d_movement.m,v 1.1 2008-03-24 14:45:34 aadler Exp $
...
vi= [vi(:).meas];
vh= [vh(:).meas];
save data_32_16x2_coarse vi vh 
save eptr_32_16x2_coarse eptr xyzr_pt
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% save data_3d_4_32_r2e16 vi vh 
% save eptr_4_32_r2e16 eptr xyzr_pt
