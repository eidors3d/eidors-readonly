...
tic; fprintf(1,'H1 Lin'); [lin_errL2(1,z_cj),lin_errH1(1,z_cj),lin_errH1tot(1,z_cj),lin_errI(1,z_cj),lin_errUS(1,z_cj),lin_errUM(1,z_cj),lin_errUSM(1,z_cj),lin_timing_solver(1,z_cj),lin_DOF(1,z_cj)]=error_2D_squ_CEM(img,'tri3',1); toc;
tic; fprintf(1,'H1 Quad'); [quad_errL2(1,z_cj),quad_errH1(1,z_cj),quad_errH1tot(1,z_cj),quad_errI(1,z_cj),quad_errUS(1,z_cj),quad_errUM(1,z_cj),quad_errUSM(1,z_cj),quad_timing_solver(1,z_cj),quad_DOF(1,z_cj)]=error_2D_squ_CEM(img,'tri6',1); toc;
