...
The goal of this work is to develop a well characterised 2D
linear EIT algorithm for lung imaging which may be used
for research and commercial applications.  All software
