...
% $Id: adler-lionheart-2005-EIDORS.tex,v 1.55 2006-02-07 03:54:35 aadler Exp $
...
\newcommand{\CN}{\tt\scriptsize} % small teletype font
...
\caption{\small
The 3D demonstration FEM provided with EIDORS3D
\cite{Polydorides_and_Lionheart_2002},
using two rings of 16 electrodes. Simulated data
are used with added noise to 20dB SNR.
Left: FEM Model with coloured elements for
reconstructed image values with an absolute value
...
\begin{figure}[th]
\begin{flushright}
\includegraphics[width= 0.15 \textwidth]{./figs/sad.eps}
\hspace{5mm}
\includegraphics[width= 0.15 \textwidth]{./figs/happy.eps}
...
\begin{figure}[th]
\begin{flushright}
\includegraphics[width=1.00 \textwidth]{figs/fig_fingers.eps}
\put(-440,130){\LARGE{\bf A}}
\put(-440,50){\LARGE{\bf B}}
\end{flushright}
\caption{\label{fig:3fingersXsect}
{\em Row A}: The three fingers test object cross section used to simulate voltage data.
{\em Row B}: Initial reconstruction of the three finger object.
From left to right, cross sections of reconstructed volume at $z$-axis
values of $0.1$, $0.83$, $1.1$, $1.72$, $2.1$, and $2.63$.
Colour mapping is uniform for each row (colourbar at right).
}
\end{figure}
...
\begin{figure}[th]
\begin{flushright}
\includegraphics[width=0.20 \textwidth,trim=170 30 20 0]{figs/three-fingers-reconstructed.eps}
\put(-90,85){\LARGE{\bf A}}
\hspace{0mm}
\includegraphics[width=0.20 \textwidth,trim=170 0 20 0]{figs/three-fingers-recon-default-mv-iso.eps}
\put(-90,85){\LARGE{\bf B}}
\hspace{0mm}
\includegraphics[width=0.25 \textwidth,trim=140 100 50 0]{figs/less-tikhonov.eps}
\put(-100,85){\LARGE{\bf C}}
\hspace{0mm}
\includegraphics[width=0.25 \textwidth,trim=160 100 30 0]{figs/lots-of-fingers.eps}
