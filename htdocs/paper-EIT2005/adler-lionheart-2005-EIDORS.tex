...
% $Id: adler-lionheart-2005-EIDORS.tex,v 1.14 2005-11-02 15:05:37 aadler Exp $
...
Adler and Guardo (1996), Polydorides \etal (2002),
Soleimani \etal (2005) and Vauhkonen \etal (2000).
...
electrode errors (Asfaw and Adler, 2005). 
...
functions are shown in \ref{fig:fig_3d}.
...
\begin{figure}[th]
\begin{flushright}
\includegraphics[width= 0.50 \textwidth]{./figs/eidors-logo.eps}
...
\item {\bf data}
An EIDORS {\tt data} object represents a set of
measures or simulated data.
...
\begin{figure}[th]
\begin{flushright}
\includegraphics[width= 0.80 \textwidth]{./figs/fig_3d.eps}
\caption{\small The 
...
\begin{figure}[th]
\begin{flushright}
\includegraphics[width= 0.50 \textwidth]{./figs/deform-grille.eps}
\caption{\small 
...
\begin{figure}[th]
\begin{flushright}
\includegraphics[width= 0.50 \textwidth]{./figs/deform.eps}
\caption{\small 
...
\item[]
Soleimani M G\'omez-Laberge C Adler A 2005
