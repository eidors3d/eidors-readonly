...
% $Id: adler-lionheart-2005-EIDORS.tex,v 1.4 2005-10-31 23:11:14 aadler Exp $
...
\begin{figure}[th]
\begin{flushright}
\includegraphics[width= 0.50 \textwidth]{./happynoise.eps}
\caption{\small 
...
\begin{figure}[th]
\begin{flushright}
\includegraphics[width= 0.80 \textwidth]{./tikhonov.eps}
\caption{\small 
...
\begin{figure}[th]
\begin{flushright}
\includegraphics[width= 0.80 \textwidth]{./tikhonov-icrime.eps}
\caption{\small 
Reconstructed images illustrating the effect of image priors,
...
\begin{figure}[th]
\begin{flushright}
\includegraphics[width= 0.80 \textwidth]{./laplace3.eps}
\caption{\small 
...
\begin{figure}[th]
\begin{flushright}
\includegraphics[width= 0.80 \textwidth]{./laplace3-icrime.eps}
\caption{\small 
Reconstructed images illustrating the effect of edge
preserving image priors,
...
%
% FIGURE: Laplace prior with inv crime and zero penalty
%
\begin{figure}[th]
\begin{flushright}
\includegraphics[width= 0.80 \textwidth]{./laplace0-icrime.eps}
\caption{\small 
Reconstructed images illustrating the effect of edge
preserving image priors,
using same mesh for model and reconstruction.
