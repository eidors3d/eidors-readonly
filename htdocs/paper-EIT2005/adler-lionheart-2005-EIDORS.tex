...
% $Id: adler-lionheart-2005-EIDORS.tex,v 1.24 2005-11-04 21:27:18 aadler Exp $
...
\CN    \CC @\\
\CN    \CC n_elems     =    size(mdl.fwd_model.elems);   @\\
\CN    \CC @\\
\CN 08 \CI \% simulate forward data \\
\CN    \CC img_sim= eidors_obj('image', 'demo');   @\\
\CN    \CC img_sim.elem_data = ones( n_elems );    @\\
\CN    \CC img_sim.fwd_model = mdl.fwd_model;   @\\
\CN 12 \CC @\\
\CN    \CC meas_h= fwd_solve( img_sim );   @\\
\CN    \CC @\\
\CN    \CC img_sim.elem_data(target_A)= 1.2;   @\\
\CN 16 \CC img_sim.elem_data(target_B)= 0.8;   @\\
\CN    \CC meas_i= fwd_solve( img_sim );   @\\
\CN    \CC @\\
\CN    \CI \% add noise \\
\CN    \CC noise= 0.1*std( meas_h.meas-meas_i.meas )*randn( n_elems ); @\\
\CN    \CC meas_i.meas= meas_i.meas + noise; @\\
\CN    \CC @\\
\CN    \CI \% inverse model and reconstruct\\
\CN    \CC mdl.hyparparameter.value= 1e-4; @\\
\CN    \CC mdl.solve = 'np_inv_solve'; @\\
\CN    \CC mdl.solve.func = 'laplace_image_prior'; @\\
