function data =ls_fwd_solve_1st_order(fwd_model, img)
% LS_FWD_SOLVE_1ST_ORDER: data= ls_fwd_solve_1st_order( img)
% Fwd solver for Andy Adler's EIT code with hex/quad elements
% Input:
%    img       = image struct
% Output:
