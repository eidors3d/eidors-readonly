function  [alpha, img, dv, opt] = line_search_o2(imgk, dx, data1, img1, N, W, hp, RtR, dv0, opt)
% function  [alpha, img, dv, opt] = line_search_o2(imgk, dx, data1, img1, N, W, hp, RtR, dv0, opt)
...
[alpha, img, dv, opt] = line_search_onm2(imgk, dx, data1, img1, N, W, hp, RtR, dv0, opt, retry, pf_max);
