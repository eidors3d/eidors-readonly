function  [alpha, img, dv, opt] = line_search_onm2(imgk, dx, data1, img1, N, W, hp, RtR, dv0, opt, retry, pf_max)
% function  [alpha, img, dv, opt] = line_search_onm2(imgk, dx, data1, img1, N, W, hp, RtR, dv0, opt)
...
if alpha == 0 && retry < 5
  ...
  [alpha, img, dv, opt] = line_search_onm2(imgk, dx, data1, img1, N, W, hp, RtR, dv0, opt, retry+1, pf_max);
end
