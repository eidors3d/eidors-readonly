function[J] = mc_calc_jacobian_point(fwd_model,img)
%CHANGE THIS NEED TO PUT Ffwd_model HERE TOO...
...
for k=1:nstims
    ...
    for j=1:size(stimkmeasmatrix,1)
        ...
        for i=1:nelecs
            data(elecnode(i),count)=stimkmeasjcur(i);
        end
    end
end
